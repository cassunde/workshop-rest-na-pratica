...
function createRequest() {
  createRequestBase('https://api.github.com/users').then(function (response) {
...
function createRequestComplex() {
  var request = new Request('https://api.github.com/users', {
    method: 'POST'
  });
...
function createRequestBase(_x) {
  return _createRequestBase.apply(this, arguments);
}

function _createRequestBase() {
  _createRequestBase = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(url) {
    var request;
...
//# sourceMappingURL=/pedidos-front.e31bb0bc.js.map